...
\subsection{Ablation}
Stage~1 pre-training alone helps Variant~2 modestly but hurts base accuracy ($1.000\to 0.525$ on Qwen2; full table in Appendix~\ref{app:ablation}). The \textbf{Fusion-LRA} intermediate (SFT only) recovers $98.8\%$ base accuracy and motivates the final Conflict-Aware architecture (Table~\ref{tab:final_performance_comparison} in Appendix~\ref{app:ablation}).
